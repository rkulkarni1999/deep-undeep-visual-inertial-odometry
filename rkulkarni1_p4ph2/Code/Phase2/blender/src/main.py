...
def main():
    ...
    while current_time < sim_stop_time:
        ...
        # current_ned_state = current_ned_state + dynamics_dt * qd.model_derivative(current_time,current_ned_state,U,tello)
        # current_ned_state_derivative = qd.model_derivative(current_time, current_ned_state, U, tello) 
    ...
    loggedDict = {'time': timeArray,
                  'state': stateArray,
                  'state_derivative': stateArray_derivative,
