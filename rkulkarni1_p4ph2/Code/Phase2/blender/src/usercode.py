...
class state_machine:
    def __init__(self):
        ...
        # self.MP = np.genfromtxt('./src/helper/MP_linear_traj.csv', delimiter=',', skip_header=0)
        # self.MP = np.genfromtxt('./src/helper/MP_square3D.csv', delimiter=',', skip_header=0)
        # self.MP = np.genfromtxt('./src/helper/MP_circle.csv', delimiter=',', skip_header=0)
        self.MP = np.genfromtxt('./src/helper/MP_circle_reverse.csv', delimiter=',', skip_header=0)
        # self.MP = np.genfromtxt('./src/helper/MP_square.csv', delimiter=',', skip_header=0)
        # self.MP = np.genfromtxt('./src/helper/MP_random.csv', delimiter=',', skip_header=0)
        print(self.MP.shape)
        self.activeIndex = 0
        ####################################################################################################
