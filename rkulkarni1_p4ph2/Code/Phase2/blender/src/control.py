...
class quad_control:
    def __init__(self):
        ...
        self.x_pid = pid(1., 0.0, 0.0, filter_tau, dt, minVal = minVel, maxVal=maxVel)
        self.y_pid = pid(1., 0.0, 0.0, filter_tau, dt, minVal = minVel, maxVal=maxVel)
        self.z_pid = pid(1., 0.0, 0.0, filter_tau, dt, minVal = minVel, maxVal=maxVel)

        # NED velocity controller. EDIT GAINS HERE
        self.vx_pid = pid(1.8, 0.0, 0.0, filter_tau, dt, minVal = minAcc, maxVal=maxAcc)
        self.vy_pid = pid(1.8, 0.0, 0.0, filter_tau, dt, minVal = minAcc, maxVal=maxAcc)
        self.vz_pid = pid(3., 0.3, 2./20, filter_tau, dt, minVal = minAcc, maxVal = maxAcc)
