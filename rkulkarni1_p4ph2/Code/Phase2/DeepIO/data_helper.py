...
class ImageSequenceDataset(Dataset):
    ...
    def __getitem__(self, index):
        raw_groundtruth = np.hsplit(self.groundtruth_arr[index],[6,15])	
        ...
        return (sequence_len, image_sequence, groundtruth_sequence,raw_IMU)
...
if __name__ == '__main__':
    ...
    #     s, x, y,imu = batch
    #     print('='*50)
    #     print('len:{}\nx:{}\ny:{}\nimu:{}'.format(s, x.shape, y.shape,imu.shape))
